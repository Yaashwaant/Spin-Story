// Simple script to seed demo wardrobe items
// Run with: node scripts/seed-demo-wardrobe-simple.js
...
async function clearExistingWardrobe(customerId) {
  const snapshot = await adminDb
    .collection("wardrobe")
...
async function addWardrobeItems(customerId, items) {
  const batch = adminDb.batch()
